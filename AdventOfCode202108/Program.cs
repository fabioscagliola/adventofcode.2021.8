...
namespace com.fabioscagliola.AdventOfCode202108
{
    ...
    class Program
    {
        class SevenSegmentDisplay
        {
            ...
            public List<string> DigitsList => new List<string> { Digit0, Digit1, Digit2, Digit3, Digit4, Digit5, Digit6, Digit7, Digit8, Digit9 };

            public SevenSegmentDisplay(string digit1, string digit4, string digit7, string digit8)
            {
        ...
        static void Main()
        {
            ...
            Regex input1Regex = new Regex(@"\b(?:[abcdefg]{2}|[abcdefg]{4}|[abcdefg]{3}|[abcdefg]{7})\b");
            ...
            for (int i = 0; i < input1.Length; i++)
            {
                ...
                SevenSegmentDisplay sevenSegmentDisplay = new SevenSegmentDisplay(digit1, digit4, digit7, digit8);
